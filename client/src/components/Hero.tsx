...
const Hero = () => {
  return (
    <section id="hero" className="relative h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519741497674-611481863552?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
        ...
        <p 
          ...
          data-animate="true"
        >
          June 15, 2024 • Lakeside Garden Estate
        </p>
        <div 
          ...
          data-animate="true"
        >
          <a href="#rsvp" className="inline-block bg-gold hover:bg-darkGold text-white font-serif uppercase tracking-wider px-8 py-3 rounded-md transition-colors">
            RSVP Now
          </a>
        </div>
      </div>
